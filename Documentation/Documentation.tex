...
Algorytm ten, poza dość prostym schematem działania, cechuje się też dobrą szybkością obliczeń (w porównaniu do innych typowych rozwiązań), oraz wysoką jakością otrzymanych wyników. Niestety ze względu na wykorzystywaną modularność, zrównoleglenie działania algorytmu nie jest trywialnym zadaniem. 
\subsection{Modyfikacje dla społeczności rozłącznych}
\subsection{Proponowane modyfikacje}
\subsection{Oczekiwania}

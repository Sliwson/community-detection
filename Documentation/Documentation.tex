...
\subsection{Oczekiwania}
Od metody oczekujemy tego, że po jej implementacji potwierdzą się wyniki podane w \cite{bt-paper1} i w przyzwoitym czasie uda się uzyskać wysokiej jakości podział na społeczności. Od modyfikacji oczekujemy, że wprowadzenie ich zmieni w istotnym stopniu uzyskany wcześniej rezultat.
\newpage

...
Ciekawe rezultaty otrzymano badając połączenie algorytmu LPA z łączeniem społeczności rozłącznych w nachodzące, zaimplementowanego w algorytmie Louvain. Zastosowano tutaj wersję podstawową algorytmu LPA dla społeczności rozłącznych, ponieważ etap łączenia wymaga, aby rezultaty bazowego algorytmu były niedeterministyczne. Przykładowe wyniki eksperymentu przedstawiono poniżej.

...
Temat społeczności nachodzących zachęca do analizy, posiadając dobrze zbilansowany próg wejścia do problemu. Nie jest to temat do przerobienia w jeden wieczór, jednak wiedza, jaką trzeba posiadać, aby zacząć analizować i modyfikować algorytmy nie stanowi bariery, której forsowanie zajmuje dużą ilosć czasu. \\

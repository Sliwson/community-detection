...
Otrzymane rezultaty wyglądają podobnie, lecz wersja korzystającej z modularności f wydaje się wyznaczać lepsze rezultaty, przy użyciu podobnej liczby społeczności. To, że rezultat jest lepszy, można uzasadnić mniejszą liczbą wierzchołków należących do bardzo dużej liczby społeczności oraz większą ich liczbą należących do kilku społeczności, będących ich nakładającą się częścią.\\
